 ...
 * @param {string} [format="px"] - Sets the format of the return value (either "number" or "px")
 * @returns {number|string}
 */
export default function unit(multiplier, format = UnitFormats.PX) {
